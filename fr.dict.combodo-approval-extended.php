...
Dict::Add('FR FR', 'French', 'Français', array(
	...
	'Class:ApprovalRule/Attribute:level1_rule' => 'Approbation Niveau1',
	'Class:ApprovalRule/Attribute:level1_rule+' => '',
	'Class:ApprovalRule/Attribute:level1_default_approval' => 'Approbation si pas de réponse niveau1',
	...
	'Class:ApprovalRule/Attribute:level1_default_approval/Value:yes+' => 'oui',
	'Class:ApprovalRule/Attribute:level1_timeout' => 'Délai d\'approbation niveau1 (heures)',
	'Class:ApprovalRule/Attribute:level1_timeout+' => '',
	'Class:ApprovalRule/Attribute:level2_rule' => 'Approbation Niveau2',
	'Class:ApprovalRule/Attribute:level2_rule+' => '',
	'Class:ApprovalRule/Attribute:level2_default_approval' => 'Approbation si pas de réponse niveau2',
	...
	'Class:ApprovalRule/Attribute:level2_default_approval/Value:yes+' => 'oui',
	'Class:ApprovalRule/Attribute:level2_timeout' => 'Délai d\'approbation niveau2 (heures)',
...
Dict::Add('FR FR', 'French', 'Français', array(
	...
	'ApprovalRule:baseinfo' => 'Information générale',
	'ApprovalRule:Level1' => 'Approbation niveau1',
	'ApprovalRule:Level2' => 'Approbation niveau2',
