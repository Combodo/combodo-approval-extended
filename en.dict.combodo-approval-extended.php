...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:ApprovalRule/Attribute:level1_rule' => 'Approval level1',
	'Class:ApprovalRule/Attribute:level1_rule+' => '',
	'Class:ApprovalRule/Attribute:level1_default_approval' => 'Automatically approved if no answer at level1',
	...
	'Class:ApprovalRule/Attribute:level1_default_approval/Value:yes+' => 'yes',
	'Class:ApprovalRule/Attribute:level1_timeout' => 'Level1 approval delay (hours)',
	'Class:ApprovalRule/Attribute:level1_timeout+' => '',
	'Class:ApprovalRule/Attribute:level2_rule' => 'Approval level2',
	'Class:ApprovalRule/Attribute:level2_rule+' => '',
	'Class:ApprovalRule/Attribute:level2_default_approval' => 'Automatically approved if no answer at level2',
	...
	'Class:ApprovalRule/Attribute:level2_default_approval/Value:yes+' => 'yes',
	'Class:ApprovalRule/Attribute:level2_timeout' => 'Level2 approval delay (hours)',
...
Dict::Add('EN US', 'English', 'English', array(
	...
	'ApprovalRule:Level1' => 'Approval level1',
	'ApprovalRule:Level2' => 'Coverage window2',
